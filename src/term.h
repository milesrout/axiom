...
extern void terminal_putbin_u32(uint32_t n);
extern void terminal_putptr(void const *p);
extern void terminal_putint_u64(uint64_t n);
extern void terminal_putint_u32(uint32_t n);
